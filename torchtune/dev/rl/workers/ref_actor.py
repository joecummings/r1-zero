...
class RefActor:
    def __init__(self, *args, **kwargs):
        ...
        self.log = utils.get_logger("DEBUG")
    ...
    def run(self):
        ...
        self.log.info("running ref actor")
        idx = 0
        while True:
            ...
            while trajectory is None:
                try:
                    if self._is_actor_zero:
                        self.log.info("Getting from rollout_queue queue.")
            ...
            self.log.info(f"Constructed trajectory: {trajectory}")
